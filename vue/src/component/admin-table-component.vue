<template>
    <div class="admin-table">
        ...
        <div class="table-console">
            ...
            <div class="default-panel" v-if="consoleType === 'PANEL'">
                <div class="item" @click="onPanelEvent('1')">
                    <i class="iconfont icon-refresh"></i>
                </div>
                <!--                <div class="item" @click="onPanelEvent('2')">-->
                <!--                    <i class="iconfont icon-setting"></i>-->
                <!--                </div>-->
                <div class="item" @click="onPanelEvent('3')">
        ...
        <div class="pagination-info" v-if="data != null && data.length > 0">
            ...
            <div class="pagination">
                ...
                <div class="page-text">
                    条/页
                    <template v-if="totalCount != null && totalCount > 0">&nbsp;&nbsp;共{{totalCount}}条</template>
                </div>
                <div class="panel">
...
<script lang="ts">
    ...
    export default class AdminTableComponent extends Vue {
        ...
        public async loadData() {
            ...
            if (this.automaticId != null && this.automaticId !== '') {
                let i = 0;
                this.data.forEach(it => {
                    i++;
                    it[this.automaticId] = i;
                });
            }
        }
        ...
        public async onPanelEvent(type: string) {
            await this.$emit('changeConsole' + type, {});
        }
